...
/**
 * Controller quản lý đơn hàng cho LvsAdmin
 * Xử lý xem, hủy, hoàn tiền đơn hàng
 */
@Controller
...
public class LvsAdminOrderController {
    ...
    public String lvsViewOrderDetail(@PathVariable Long id,
        ...
        return "LvsAdmin/LvsOrderDetail";
    }
    ...
    public String lvsGenerateInvoice(@PathVariable Long id,
        ...
        return "LvsAdmin/LvsOrderInvoice";
    }
