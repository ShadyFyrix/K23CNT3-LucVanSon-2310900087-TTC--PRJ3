...
public interface LvsProjectRepository extends JpaRepository<LvsProject, Long> {
    ...
    Page<LvsProject> findByLvsUser_LvsUserIdAndLvsStatus(Long lvsUserId, LvsProjectStatus lvsStatus, Pageable pageable);
    ...
    Page<LvsProject> findByLvsCategory_LvsCategoryIdAndLvsStatus(Integer lvsCategoryId, LvsProjectStatus lvsStatus, Pageable pageable);
    ...
    void updateRating(@Param("projectId") Long projectId, @Param("rating") Double rating, @Param("reviewCount") Integer reviewCount);
